...
- **2026-08-13**: Portfolio upgrade — removed SRL regime entirely (store, card, chart, print, fiscal rules, admin contributions engine); added 2026 fiscal payment timeline simulator (tax-engine/deadlines.ts + TaxDeadlines.vue: saldo+acconti storico/previsionale, INPS GS 2 rate, Artigiani/Commercianti 40/30/30, addizionali; share URL v3); glassmorphism redesign keeping blue+gold palette (ambient gradients, glass cards/inputs, print overrides). Build green, 66 tests.
